...
gsutil cp validation/component.yaml gs://${BUCKET}/components/validation/component.yaml
gsutil acl ch -u AllUsers:R gs://${BUCKET}/components/validation/component.yaml
